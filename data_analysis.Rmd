...
educ <- alldata[,c("GENDER","EDU_LVL")] # subsetting data
...
# proportion tables
round(prop.table(table(educ$highest,educ$GENDER), margin = 2),4)
#comparing missing with complete gender data
round(prop.table(table(educ$highest[educ$GENDER %in% c("Male", "Female", "Other")],
                       educ$GENDER[educ$GENDER %in% c("Male", "Female", "Other")]), margin = 2),4)
round(prop.table(table(educ$highest[educ$GENDER == "Missing"],educ$GENDER[educ$GENDER == "Missing"]), margin = 2),4)

# NA counts
sum(is.na(educ$EDU_LVL[educ$GENDER=="Female"]))
sum(is.na(educ$EDU_LVL[educ$GENDER=="Male"]))
sum(is.na(educ$EDU_LVL[educ$GENDER=="Other"]))
```
...
Here's the 15 most prominent ccities in our dataset. 