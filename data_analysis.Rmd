...
A proposed model: 
$$ Y=\beta_0 + X\beta_c + SHB\beta_{SHB} + Gender*SHB*\beta_{inter} + \epsilon $$
...
unobserved variables mah impact both salary history disclosure *and* other
...
mldata$Industry <- as.numeric(as.factor(mldata$Industry))
mldata$EDU_LVL <- as.numeric(as.factor(mldata$EDU_LVL))
